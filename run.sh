...
/usr/sbin/pure-ftpd-mysql -l mysql:/etc/pure-ftpd/db/mysql.conf -E -O clf:/var/log/pure-ftpd/transfer.log -c 100 -C 100 -8 UTF-8 -u 30 -U 111:000 -p 30000:30009 -Y $TLS -H -A -B && tail -f /var/log/*.log